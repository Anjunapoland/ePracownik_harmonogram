...
<title>Logowanie — ePracownik SCK</title>
...
<div class="login-box">
    <div style="margin-bottom:16px"><img src="assets/logo_epracownik.png" alt="ePracownik" style="height:50px"></div>
    <h1>ePracownik SCK</h1>
