...
<nav class="sidebar" id="sidebar">
    ...
    <div class="sb-nav">
        ...
        <?php $fmActive = in_array(basename($_SERVER['SCRIPT_NAME']), ['forms.php','form_wifi.php','form_overtime.php','form_leave.php']); ?>
            ...
            <div class="sb-user">
                ...
                <div class="sb-user-info">
                    ...
                    <div class="sb-user-role">
                        ...
                        <?= $user['role']==='admin'?'Administrator':'Pracownik' ?> · <?= h($user['department']) ?>
                    </div>
                </div>
            </div>
