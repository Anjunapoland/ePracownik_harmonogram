...
$myLp = $myB ? (float)$myB['leave_prev_year'] : 0;
$myLc = $myB ? (float)$myB['leave_current_year'] : 0;
$myOt = $myB ? (float)$myB['overtime_hours'] : 0;
$myTotal = $myLp + $myLc;
$myUsed = $usedLeave[$user['id']] ?? 0;
$myRemain = $myTotal - $myUsed;
        ...
        <div class="ld-summary">
            <div class="ld-stat" style="animation-delay:.15s">
                ...
                <div class="ld-stat-info">
                    ...
                    <div class="ld-stat-sub">z roku <?=$selYear-1?></div>
                </div>
            </div>
            <div class="ld-stat" style="animation-delay:.25s">
                ...
                <div class="ld-stat-info">
                    ...
                    <div class="ld-stat-sub">rok <?=$selYear?></div>
                </div>
            </div>
...
<div style="padding:16px 24px;display:flex;gap:12px;align-items:center">
